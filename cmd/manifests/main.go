...
var (
	sshAuthKeys app.FlagStringSlice
	server      = flag.String(
		"vsphere-server",
		"",
...
func (p provider) GetTemplateData() map[string]interface{} {
	return map[string]interface{}{
		"ProviderManagerImage":    *managerImage,
		"ProviderManagerLogLevel": *managerLogLevel,
	}
}
