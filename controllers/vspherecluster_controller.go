...
func (r clusterReconciler) waitUntilAPIEndpointIsOnline(apiEndpoint infrav1.APIEndpoint) error {
	addr := fmt.Sprintf("%s:%d", apiEndpoint.Host, apiEndpoint.Port)
	dialer := &net.Dialer{Timeout: time.Minute * 3}
